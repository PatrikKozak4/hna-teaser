    ...
    <section className="px-md-5 mx-md-5 dark-grey-text text-center text-lg-left">
      <div className="row">
        ...
        <div className="col-lg-6 mb-4 mb-lg-0">
          ...
          <p className="text-muted">A subscription to ArcDeed allows users access 
          to our vast network of experts within the platform. These experts can 
          serve as a means of guidance, answer questions, and/or provide improvements 
          to individual accounts.  
          </p>

          <p className="text-muted">We will accommodate any user and solve 
          problems that can’t be immediately fixed in a software update.</p>
