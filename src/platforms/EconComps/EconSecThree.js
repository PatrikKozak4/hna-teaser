    ...
    <section className="px-md-5 mx-md-5 text-center text-lg-left text-white">
        <div className="row">
            <div className="col-md-6 mb-4 mb-md-0">
              ...
              <p className="">A subscription to ArcDeed grants users access to an HNA.LIVE account 
              that is tailored to accommodate their unique needs and allows for personalization 
              of all content. </p>
